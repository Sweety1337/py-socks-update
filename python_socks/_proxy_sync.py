...
class Proxy:
    ...
    def create(cls, proxy_type: ProxyType, host: str, port: int,
               ...
               client: str = None, proxy: str=None, rdns: bool = None) -> SyncProxy:
    ...
    @classmethod
    def from_url(cls, url: str, client: str, proxy: str, **kwargs) -> SyncProxy:
...
class HttpProxy(BaseProxy):
    def __init__(self, proxy_host, proxy_port, username=None, password=None, client=None, proxy=None):
        super().__init__(
            proxy_host=proxy_host,
            proxy_port=proxy_port
        )
